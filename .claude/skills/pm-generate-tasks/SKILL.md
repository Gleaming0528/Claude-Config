...
- **Context Source:** 结合 PRD 文档和项目上下文

## Output

- **Format:** Markdown (`.md`)
- **Location:** 项目 `docs/` 目录或用户指定位置
...
8.  **Save Task List:** Save the generated document as `tasks-[feature-name].md` 在项目 `docs/` 目录或用户指定位置。
...
## Skill Chaining
- **Before this skill:** Use `pm-create-prd` 定义需求
- **Related workflow:** `pm-create-prd` → this skill → 开发实现
